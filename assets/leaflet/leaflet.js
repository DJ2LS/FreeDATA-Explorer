...
!(function (t, e) {
  ...
  function Ie(t) {
    return (
      S(t, "mousedown touchstart dblclick contextmenu", Be),
      ...
      Ai.extend({
        ...
        onAdd: function (t) {
          (Ai.prototype.onAdd.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof mi || this._source.on("preclick", Be)));
        },
        onRemove: function (t) {
          (Ai.prototype.onRemove.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof mi || this._source.off("preclick", Be)));
        },
        getEvents: function () {
        ...
        _adjustPan: function (t) {
          ...
          this.options.autoPan &&
            ...
            (e = this._map),
            (i = parseInt(pe(this._container, "marginBottom"), 10) || 0),
  ...
  var _t = n.extend({
    ...
    Ct =
      (B.addInitHook("addHandler", "boxZoom", _t),
    ...
    Zt =
      (B.addInitHook("addHandler", "doubleClickZoom", Ct),
      B.mergeOptions({
        dragging: !0,
        inertia: !0,
    ...
    St =
      (B.addInitHook("addHandler", "dragging", Zt),
    ...
    Et =
      (B.addInitHook("addHandler", "keyboard", St),
      B.mergeOptions({
        scrollWheelZoom: !0,
    ...
    kt =
      (B.addInitHook("addHandler", "scrollWheelZoom", Et),
      B.mergeOptions({
    ...
    At =
      (B.addInitHook("addHandler", "tapHold", kt),
      B.mergeOptions({ touchZoom: b.touch, bounceAtZoomLimits: !0 }),
      n.extend({
        addHooks: function () {
    ...
    Yi =
      (B.addInitHook("addHandler", "touchZoom", At),
      (B.BoxZoom = _t),
      (B.DoubleClickZoom = Ct),
      (B.Drag = Zt),
      (B.Keyboard = St),
      (B.ScrollWheelZoom = Et),
      (B.TapHold = kt),
      (B.TouchZoom = At),
      (t.Bounds = f),
      (t.Browser = b),
