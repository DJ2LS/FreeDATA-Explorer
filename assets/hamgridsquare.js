...
// MOD BY DJ2LS
  if (grid.length==6){
       var grid = grid[0].toUpperCase() + grid[1].toUpperCase() + grid[2] + grid[3] + grid[4].toLowerCase() + grid[5].toLowerCase();
  };
  if (grid.length==4) {
       var grid = grid[0].toUpperCase() + grid[1].toUpperCase() + grid[2] + grid[3];
};
